...
function validarNombre(control) {
    if (control.value == "") {
        ...
        capa.innerHTML = "<div class='alert alert-danger' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/x.png' alt='Correcto' style='width: 16px; height: 16px;' />  Introduzca el nombre</div>";
        document.getElementById('registrar').disabled = true;
    } else {
        document.getElementById('nombre').style.color = 'green';
        //Cojo el span y lo dejo con texto vacío porque es correcto
        var capa = document.getElementById("textoNombre");
        capa.innerHTML = "<div class='alert alert-success' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/v.png' alt='Correcto' style='width: 16px; height: 16px;' />  Nombre correcto</div>";
    }
}
...
function validarApellido(control) {
    if (control.value == "") {
        ...
        capa.innerHTML = "<div class='alert alert-danger' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/x.png' alt='Correcto' style='width: 16px; height: 16px;' />  Introduzca el apellido</div>";
        document.getElementById('registrar').disabled = true;
        document.getElementById('registrar').disabled = true;
    } else {
        ...
        //Cojo el span y lo dejo con texto vacío porque es correcto
        var capa = document.getElementById("textoApellido");
        capa.innerHTML = "<div class='alert alert-success' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/v.png' alt='Correcto' style='width: 16px; height: 16px;' />  Apellido correcto</div>";
    }
}
...
function validarEmail(control) {
    if (control.value == "") {
        ...
        capa.innerHTML = "<div class='alert alert-danger' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/x.png' alt='Correcto' style='width: 16px; height: 16px;' />  Introduzca un email</div>";
        document.getElementById('registrar').disabled = true;
    } else {
        document.getElementById('email').style.color = 'green';
        //Cojo el span y lo dejo con texto vacío porque es correcto
        var capa = document.getElementById("textoEmail");
        capa.innerHTML = "<div class='alert alert-success' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/v.png' alt='Correcto' style='width: 16px; height: 16px;' />  Email Correcto</div>";
    }
}
...
function comprobarLongitudPass(control) {
    ...
    if (control.value.length < 8 || pass !== passRepetida) {
        ...
        capa.innerHTML = "<div class='alert alert-danger' style='height: 98px; margin-top: 25px;'><img src='Imagenes/registro/x.png' alt='Correcto' style='width: 16px; height: 16px;' />  Al menos 8 caracteres y las contraseñas deben ser iguales</div>";
        ...
        var capa = document.getElementById("textoPassword");
        capa.innerHTML = "<div class='alert alert-success' style='height: 34px; margin-top: 25px; padding: 6px 12px;'><img src='Imagenes/registro/v.png' alt='Correcto' style='width: 16px; height: 16px;' />  Contraseña correcta</div>";
